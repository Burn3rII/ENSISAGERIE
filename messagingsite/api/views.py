...
def task_detail(request, task_id):
    ...
    return render(request, "api/task_details.html", context)
...
def user_detail(request, user_id):
    ...
    return render(request, "api/user_details.html", context)
...
def diffusion_list_detail(request, diffusion_list_id):
    ...
    return render(request, "api/diffusion_list_details.html",
                  context)
